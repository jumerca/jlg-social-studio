...
const labels={dashboard:'Tableau de bord',orders:'Demandes clients',packs:'Toutes mes offres',clients:'Clients',projects:'Projets',tasks:'Production',quotes:'Devis',invoices:'Finance',settings:'Réglages'};
