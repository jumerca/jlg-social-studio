...
const fakeData={
 ...
 invoices:[{id:'i1',reference:'FAC-QA-001',kind:'Acompte',status:'Partiellement payée',client_id:'c1',project_id:'pr1',quote_id:'q1',items:[{id:'li1',label:'Flyer simple',description:'Flyer QA',category:'Supports imprimés',unit:'support',qty:1,unit_price:90,total:90}],subtotal:90,discount_amount:0,gross_total:90,deduction_amount:0,total:27,paid_amount:15,issue_date:'2026-09-25',due_date:'2026-10-02',notes:'Conditions QA'},{id:'i2',reference:'FAC-QA-002',kind:'Facture',status:'Payée',client_id:'c1',project_id:'pr2',quote_id:'q2',items:[{id:'li2',label:'Livrable final',description:'QA',category:'Digital',unit:'prestation',qty:1,unit_price:100,total:100}],subtotal:100,discount_amount:0,gross_total:100,deduction_amount:0,total:100,paid_amount:100,issue_date:'2026-09-25',due_date:'2026-10-02',notes:'Payé'}],
